        ...
        <CardContent className="pt-8 space-y-10">
          ...
          >
                    ...
                    <motion.div className="relative group" variants={avatarVariants}>
                      ...
                      >
                        <Avatar className="size-24 border-2 border-white dark:border-zinc-950 shadow-sm">
                          <AvatarImage
                            src={previewImage || "/images/avatar-placeholder.png"}
                            alt="Profile"
                          />
                      ...
                      />
                      {/* Edit button with rotation on hover */}
                      <motion.div
                      ...
                      >
                        <Button
                          ...
                          className="size-8 rounded-full bg-[#22c55e] hover:bg-[#1eb054] text-white border-2 border-white dark:border-zinc-950 shadow-sm transition-colors"
                        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    children={(field) => (
                      <Field>
                        ...
                        <Input
                          ...
                          className="h-12 px-4 rounded-xl border-zinc-200 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-900/50 transition-shadow focus:shadow-md"
                        />
                  ...
                  children={(field) => (
                    <Field>
                      ...
                      <Textarea
                        ...
                        value={field.state.value}
                        onChange={(e) => field.handleChange(e.target.value)}
                        className="min-h-[120px] p-4 rounded-xl border-zinc-200 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-900/50 resize-none transition-shadow focus:shadow-md"
                      />
                      <FieldError errors={field.state.meta.errors} />
                    </Field>
                  )}
              ...
              {/* Hourly Rate + Account Meta */}
              <motion.div
                variants={itemVariants}
                className="space-y-6 md:col-span-2 flex flex-col md:flex-row md:items-end justify-between gap-6 pt-2"
              >
                <form.Field
                  name="hourlyRate"
                  children={(field) => (
            ...
            <motion.div
              variants={itemVariants}
              className="flex items-center justify-end gap-4 pt-6 border-t border-zinc-100 dark:border-zinc-800"
            >
