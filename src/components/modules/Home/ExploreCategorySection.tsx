                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {categories.data?.length > 0 ? (
                        categories.data?.map((category: any, index: number) => (
                            <ScrollMotion key={category.id} delay={index * 0.1}>
                                <div 
                        ...
                        [
                            ...
                            <ScrollMotion key={cat.id} delay={index * 0.1}>
                                <div className="relative h-[280px] rounded-3xl overflow-hidden bg-muted">
